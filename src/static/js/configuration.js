        ...
        if (response.peer_data.length === 0){
            ...
            response.peer_data.forEach(function(peer){
                ...
                let peer_name =
                    ...
                    '</div>';
                let peer_transfer = '<div class="col-12 peer_data_group" style="text-align: right; display: flex; margin-bottom: 0.5rem"><p class="text-primary" style="text-transform: uppercase; margin-bottom: 0; margin-right: 1rem"><small>'+ roundN(peer.rx*1024, 1) +' MB/s <i class="bi bi-arrow-down-right"></i> '+ roundN(peer.total_receive + total_r, 4) +' GB</small></p> <p class="text-success" style="text-transform: uppercase; margin-bottom: 0"><small>'+ roundN(peer.tx*1024, 1) +' MB/s <i class="bi bi-arrow-up-right"></i> '+ roundN(peer.total_sent + total_s, 4) +' GB</small></p> </div>';
